...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should reject invalid addresses" do
    ...
    invalid_addressess =  %w[user@example,com user_at_foo.org user.name@example. foo@bar_baz.com foo@bar+baz.com]
    ...
    test "email addresses should be unquie" do
    ...
    test "email address should be saved as lowercase" do
      mixed_case_email = "Foodbase@ExampeElk.com"
